...
// Josh was naughty, removed runSequence task
// 'clean', from the first position in gulp task 'build'
// of course you can manually do it via terminal, but that removes my
// demo page from /dev folder.
